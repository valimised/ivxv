...
version = '0.9'
document_number = 'IVXV-AR-%s' % version
...
#
html_title = 'IVXV arhitektuur v{}'.format(version)
...
htmlhelp_basename = 'IVXV-arhitektuur'
...
latex_documents = [
    (master_doc, 'IVXV-arhitektuur.tex',
     'IVXV arhitektuur',
     'Cybernetica AS', 'ivxv-technical'),
]
...
texinfo_documents = [
    (master_doc, 'IVXV-arhitektuur', 'IVXV arhitektuur',
     author, 'IVXV-arhitektuur', 'One line description of project.',
     'Miscellaneous'),
]
