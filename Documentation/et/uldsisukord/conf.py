...
version = '0.9'
document_number = 'IVXV-YS-%s' % version
document_type = ''
...
#
html_title = 'IVXV dokumentatsiooni üldsisukord v{}'.format(version)
...
htmlhelp_basename = 'IVXV-dokumentatsiooni-uldsisukord'
...
latex_documents = [
    (master_doc, 'IVXV-dokumentatsiooni-uldsisukord.tex',
     'IVXV '
     'dokumentatsiooni üldsisukord',
     '', 'ivxv-technical'),
]
...
texinfo_documents = [
    (master_doc, 'IVXV-dokumentatsiooni üldsisukord',
     'IVXV dokumentatsiooni üldsisukord',
     author, 'IVXV-dokumentatsiooni üldsisukord',
