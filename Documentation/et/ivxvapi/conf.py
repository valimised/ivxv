...
version = '0.9'
document_number = 'IVXV-API-%s' % version
...
#
html_title = 'IVXV API v{}'.format(version)
...
texinfo_documents = [
    (master_doc, 'IVXV-API', 'IVXV API',
     author, 'IVXV-API', 'One line description of project.',
     'Miscellaneous'),
]
