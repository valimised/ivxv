...
version = '0.9'
document_number = 'IVXV-SVR-%s' % version
...
#
html_title = 'IVXV võtmerakendus v{}'.format(version)
...
htmlhelp_basename = 'IVXV-votmerakendus'
...
latex_documents = [
    (master_doc, 'IVXV-votmerakendus.tex',
     'IVXV võtmerakendus',
     '', 'ivxv-technical'),
]
...
texinfo_documents = [
    (master_doc, 'IVXV-votmerakendus', 'IVXV votmerakendus',
     author, 'IVXV-votmerakendus', 'One line description of project.',
     'Miscellaneous'),
]
