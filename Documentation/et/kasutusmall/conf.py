...
version = '0.9'
document_number = 'IVXV-KM-%s' % version
...
#
html_title = 'IVXV kasutusmallid v{}'.format(version)
...
htmlhelp_basename = 'IVXV-kasutusmallid'
...
latex_documents = [
    (master_doc, 'IVXV-kasutusmallid.tex',
     'IVXV kasutusmallid',
     '', 'ivxv-technical'),
]
...
texinfo_documents = [
    (master_doc, 'IVXV-kasutusmallid', 'IVXV kasutusmallid',
     author, 'IVXV-kasutusmallid', 'One line description of project.',
     'Miscellaneous'),
]
