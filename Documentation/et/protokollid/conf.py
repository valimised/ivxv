...
version = '0.9'
document_number = 'IVXV-PR-%s' % version
...
#
html_title = 'IVXV protokollid v{}'.format(version)
...
htmlhelp_basename = 'IVXV-protokollid'
...
latex_documents = [
    (master_doc, 'IVXV-protokollid.tex',
     'IVXV protokollid',
     '', 'ivxv-technical'),
]
...
texinfo_documents = [
    (master_doc, 'IVXV-protokollid', 'IVXV protokollid',
     author, 'IVXV-protokollid', 'One line description of project.',
     'Miscellaneous'),
]
