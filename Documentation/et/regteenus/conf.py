...
version = '0.9'
document_number = 'IVXV-SRT-%s' % version
...
#
html_title = 'IVXV registreerimisteenus v{}'.format(version)
...
htmlhelp_basename = 'IVXV-registreerimisteenus'
...
latex_documents = [
    (master_doc, 'IVXV-registreerimisteenus.tex',
     'IVXV registreerimisteenus',
     '', 'ivxv-technical'),
]
...
texinfo_documents = [
    (master_doc, 'IVXV-registreerimisteenus', 'IVXV registreerimisteenus',
     author, 'IVXV-registreerimisteenus', 'One line description of project.',
     'Miscellaneous'),
]
